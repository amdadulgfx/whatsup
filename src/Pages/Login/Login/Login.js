...
const Login = () => {
    return (
        <div className='py-4 space-y-6 h-screen flex  flex-col items-center  justify-center bg-gray-100'>
            ...
            <div className='p-5 filter drop-shadow bg-white rounded-lg '>
                <form action="" className='space-y-3'>

                    <input className='px-3 py-2 bg-gray-200 rounded-md' type="email" placeholder='Email' /> <br />
                    <input className='px-3 py-2 bg-gray-200 rounded-md' type="password" placeholder='Password' /> <br />
